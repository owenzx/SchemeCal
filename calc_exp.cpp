...
//Number *calc_exp(){
	...
	if (*tk0 == '(')
	{
		...
		else if (strcmp(tk1, "char-numeric?") == 0)opt = new IsChar_num();
		else if (strcmp(tk1, "char-whitespace?") == 0)opt = new IsChar_space();
		else if (strcmp(tk1, "char-upper-case?") == 0)opt = new IsChar_upc();
		else if (strcmp(tk1, "char-lower-case?") == 0)opt = new IsChar_lowc();
